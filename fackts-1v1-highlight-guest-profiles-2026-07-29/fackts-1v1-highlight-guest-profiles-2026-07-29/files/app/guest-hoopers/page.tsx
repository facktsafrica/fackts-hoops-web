          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3 md:gap-5">
            {guestHoopers.map((guest: any) => (
              <Link
                ...
                className="group overflow-hidden rounded-2xl border border-slate-800 bg-slate-900 shadow-lg shadow-black/20 transition hover:-translate-y-0.5 hover:border-orange-400/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 md:rounded-[2rem] md:shadow-xl"
              >
                ...
                <div className="p-3 md:p-5">
                  ...
                  <div className="mt-4 border-t border-slate-800 pt-3 text-[10px] font-black uppercase tracking-[0.16em] text-orange-300 transition group-hover:text-orange-200 md:text-xs">
                    View Full Profile
                  </div>
                </div>
              </Link>
