  ...
  return (
    <main className="fackts-public-bg min-h-screen text-white">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-14 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-[2rem] border border-orange-400/30 bg-gradient-to-br from-orange-500/20 via-slate-950/90 to-blue-700/20 px-5 py-7 sm:p-10">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-orange-300">Bring FACKTS courtside</p>
          <h2 className="mt-3 max-w-3xl text-3xl font-black uppercase sm:text-5xl">Your next basketball event deserves a complete record.</h2>
          <Link href="/book-coverage" className="mt-6 flex w-full items-center justify-center rounded-full bg-orange-500 px-5 py-3 text-center text-xs font-black uppercase tracking-[0.1em] text-black hover:bg-orange-400 sm:inline-flex sm:w-auto sm:px-6 sm:tracking-[0.12em]">Request coverage</Link>
        </div>
      </section>
    </main>
  );
