const CACHE_NAME = "fackts-hoops-pwa-v7-20260803";
...
async function staticAsset(request) {
  ...
  try {
    ...
    // Cached assets are an offline fallback, never the first choice. This
    // prevents a new deployment from mixing fresh pages with old JS chunks.
