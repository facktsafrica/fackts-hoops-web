  ...
  return (
    <main className="fackts-public-bg min-h-screen text-white">
      ...
      <section className="mx-auto max-w-7xl px-5 pb-14 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-[2rem] border border-orange-400/30 bg-gradient-to-br from-orange-500/20 via-slate-950/90 to-blue-700/20 p-7 sm:p-10">
          ...
          <Link href="/book-coverage" className="mt-6 inline-flex rounded-full bg-orange-500 px-6 py-3 text-xs font-black uppercase tracking-[0.12em] text-black hover:bg-orange-400">Request coverage</Link>
        </div>
      </section>
    </main>
  );
