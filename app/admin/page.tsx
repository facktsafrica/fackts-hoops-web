    ...
    <main className="min-h-screen bg-slate-950 px-6 py-8 text-white">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          ...
          <h1 className="mt-2 text-4xl font-black tracking-tight">Player Management</h1>
          <p className="mt-3 text-slate-400">
            Add, edit, activate, and set a featured player for the homepage.
          </p>
        </div>
        ...
        <div className="grid gap-8 xl:grid-cols-[1fr,1fr]">
          ...
          <section className="rounded-3xl border border-slate-800 bg-slate-900 p-6">
            <div className="mb-5">
              <div className="text-sm uppercase tracking-wide text-orange-300">Player List</div>
