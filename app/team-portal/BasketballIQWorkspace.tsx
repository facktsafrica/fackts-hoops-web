...
export default function BasketballIQWorkspace({
  ...
  const modes: Array<[Mode, string, string]> = [
    ...
    ["coach", "Briefings", "Share development work"],
  ];
      ...
      <section className="overflow-hidden rounded-[1.75rem] border border-white/10 bg-slate-950 shadow-2xl">
        <div className="border-b border-white/10 bg-[linear-gradient(120deg,rgba(249,115,22,.14),transparent_48%)] p-5 sm:p-7">
          <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
            <div><p className="text-[9px] font-black uppercase tracking-[.2em] text-[var(--club-accent)]">Basketball IQ</p><h2 className="mt-2 text-3xl font-black uppercase sm:text-4xl">Performance command desk</h2><p className="mt-3 max-w-3xl text-sm leading-6 text-slate-400">Capture the game once. Use it immediately for training decisions. Super Admin still controls what becomes an official public record.</p></div>
