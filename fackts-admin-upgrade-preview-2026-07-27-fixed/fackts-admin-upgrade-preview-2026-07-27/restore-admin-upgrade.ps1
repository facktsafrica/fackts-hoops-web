...
Write-Host ""
Write-Host "SUCCESS: The files were restored to their pre-upgrade state." -ForegroundColor Green
Write-Host "The Supabase SQL is not reversed by this file restore."
